...
namespace Neo.UI
{
    ...
    {
        private const string nullParamValue = "(null)";                                             // default value for params that need editing
        private const string addParamString = "[add param]";                                        //
        ...
        private void txtScriptHash_TextChanged(object sender, EventArgs e)
        {
            ...
            MainForm.Instance.scListAdd(scriptHash.ToString(), true);
        ...
        /**
         * user has clicked the parameter expand button, populate the list of defined parameters
         */
        private void initParmTreeView()
        {
            //paramListView.Items.Clear();
            //paramListView.Items.AddRange(requiredParameters.Select((p, i) => addParamListItem(i, p.Type.ToString(), p.Value, true)).ToArray());
            treeParamList.Nodes.Add(new TreeNode("Parameter List"));
        ...
        {
            return new TreeNode(addParamString);
        ...
        private void invokeParameterEditor()
        {
            ...
            if (listItemExists)
            {
                ...
                if (paramValue.Equals(nullParamValue))
                {
                    paramValue = null;
                }
            }
        ...
        private void treeParamList_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                if (treeParamList.SelectedNode.Text.Contains(addParamString) || treeParamList.SelectedNode == treeParamList.Nodes[0])
                {
                    return;
                }
